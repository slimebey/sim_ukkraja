<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <div class="info">
        <a href="#" class="d-block">{{ $siswa->nama ?? Auth::user()->username }}</a>
        <small class="text-muted">{{ $siswa->kelas ?? '' }} {{ $siswa->jurusan ?? '' }}</small>
      </div>
    </div>
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="{{ route('siswa.buat') }}" class="nav-link {{ Request::routeIs('siswa.buat') ? 'active' : '' }}">
            <i class="nav-icon fas fa-plus-circle"></i>
            <p>Buat Aspirasi</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="{{ route('siswa.histori') }}" class="nav-link {{ Request::routeIs('siswa.histori', 'siswa.show') ? 'active' : '' }}">
